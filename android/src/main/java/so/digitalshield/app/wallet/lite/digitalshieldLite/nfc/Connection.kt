package so.digitalshield.app.wallet.lite.digitalshieldLite.nfc

import android.nfc.TagLostException
import android.nfc.tech.IsoDep
import org.haobtc.digitalshield.card.gpchannel.GPChannelNatives
import org.haobtc.digitalshield.card.gpchannel.GPChannelNatives.nativeGPCFinalize
import so.digitalshield.app.wallet.lite.keys.KeysNativeProvider
...
import so.digitalshield.app.wallet.lite.digitalshieldLite.entitys.*
import so.digitalshield.app.wallet.lite.digitalshieldLite.nfc.GPCAPDUGenerator.buildGPCAPDU
import so.digitalshield.app.wallet.lite.digitalshieldLite.nfc.GPCAPDUGenerator.combCommand
import so.digitalshield.app.wallet.lite.utils.HexUtils
import so.digitalshield.app.wallet.lite.utils.HexUtils.byteArr2HexStr
import so.digitalshield.app.wallet.lite.utils.HexUtils.hexString2Bytes
import so.digitalshield.app.wallet.lite.utils.LogUtil.printLog
